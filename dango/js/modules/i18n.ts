...
const TRANSLATIONS: Record<LangCode, Record<string, string>> = {
    zh: {
        ...
        tagging_guide_tip1: "· 点击 / f 跳转 ：添加 / 取消序号",
        tagging_guide_tip2: "· Delete / Backspace ：清除选中项序号 (Ctrl+A 全选)",
        help_tagging: "标记演示模式",
    ...
    en: {
        ...
        tagging_guide_tip1: "· Click / f jump: Tag / untag step",
        tagging_guide_tip2: "· Delete / Backspace: Clear steps of selection (Ctrl+A all)",
