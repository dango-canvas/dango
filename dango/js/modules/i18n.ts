...
const TRANSLATIONS: Record<LangCode, Record<string, string>> = {
    zh: {
        ...
        toast_png_no_dango: "该图片未包含 Dango 画板数据",
        toast_canvas_empty: "画布为空，无法导出",
        toast_easter_dango: "🍡 团子连击",
        help_delete: "删除选中",
        help_home: "回归中心",
        help_pan_zoom: "平移 / 缩放",
        help_global_view: "全景巡视 / 聚焦",
        help_center: "回归视图中心",
        help_save: "保存画板文件",
        ...
        help_select_all_cancel: "全选 / 取消选择",
    ...
    en: {
        ...
        toast_png_no_dango: "No Dango canvas data found in this image",
        ...
        help_global_view: "Overview & Focus",
        ...
        btn_export_image: "PNG",
        toast_btn_embed: "EMBED",
        ...
        help_select_all_cancel: "Select All / Deselect",
