...
<div align="center">
  <img alt="Dango Canvas Screenshot" src="https://github.com/user-attachments/assets/93836e5e-ba90-48d3-a248-a60ef8d0bfff" />
  <br />
  <br />
...
* **Standalone Single File**: Download `dango.zip` from [Releases](https://github.com/dango-canvas/dango/releases), extract it, and double-click `dango.html` to run.
* **Docker**:
  ```bash
